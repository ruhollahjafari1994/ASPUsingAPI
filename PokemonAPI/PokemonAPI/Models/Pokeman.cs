...
namespace PokemonAPI.Models
{
    ...
    public class Other
    {
        ...
        public OfficialArtwork official { get; set; }
}
...
public class GenerationIii
{
    ...
    public FireredLeafgreen firered { get; set; }
public RubySapphire ruby { get; set; } 
    }
...
{
    public DiamondPearl diamond { get; set; }
public HeartgoldSoulsilver heartgold { get; set; }
...
{
    public BlackWhite black { get; set; } 
    }
...
{
    public OmegarubyAlphasapphire omegaruby{ get; set; }
...
public class GenerationVii
{
    ...
    public UltraSunUltraMoon ultra { get; set; } 
    }
...
{
    public GenerationI generation { get; set; }
